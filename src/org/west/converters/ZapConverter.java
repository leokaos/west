 ...
 */
public class ZapConverter implements ImovelConverter {
     ...
     * dos imóveis.
     */
    public ZapConverter(Document doc) {
        this.doc = doc;
        createMapaTipo();
    }
    ...
    public Object toFormato(Imovel imovel) {
        ...
        imovelXML.appendChild(createElementoGenerico("CodigoCliente", "903167"));
        ...
        Informacao info = InformacaoDAO.loadInformacaoByQuery("imovel=" + imovel.getReferencia() + " and anuncio='Zap'", "anuncio");
    ...
    private void createMapaTipo() {
        ...
        mapaTipo.put(TipoDAO.load("Sítio"), new String[]{"Rural", "Sítio", "Padrão"});
        ...
        mapaTipo.put(TipoDAO.load("Terreno"), new String[]{"Terreno", "Terreno Padrão", "Padrão"});
        mapaTipo.put(TipoDAO.load("Casa de Vila"), new String[]{"Casa", "Casa de Vila", "Sobrado/Duplex"});
    }
